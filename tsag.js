...
GameEngine.prototype.loop = function() 
{
	...
	var testWidth = canvas_.width / self.scale_;
	var testHeight = canvas_.height / self.scale_;

	if ((self.scale_ == 0) || (self.view_width_ != view.width) || (self.view_height_ != view.height)) {
		self.screen.width_ = canvas_.width;
		
		console.log(self.screen.width_);
		console.log(canvas_.width);
		...
		testWidth = canvas_.width / self.scale_;
		
		//console.log(canvas_.width / self.scale_);
		//console.log(testWidth);
		//console.log(screen.width); //WHY THE FUCK
		
		screen.height = canvas_.height / self.scale_;
		testHeight = canvas_.height / self.scale_;
	...
	if (self.board_ != null) {
		...
		var endy = parseInt(starty + (testHeight / self.tileheight_) + 2); //was .height
		var startx = parseInt(view.x / self.tilewidth_);
		var endx = parseInt(startx + (testWidth / self.tilewidth_) + 2);
		//console.log(self.tilewidth_);
		var row, col;
